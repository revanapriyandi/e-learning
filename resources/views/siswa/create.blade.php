...
<script>
            ...
            $.ajax({
                ...
                success: function(res) {
                    if(res.exists){
                        ...
                        $('#error_username').html('<label class="text-success">Username dapat digunakan</label>');
        ...
        function duplicateNis(element){
            ...
            $.ajax({
                ...
                success: function(res) {
                    if(res.exists){
                        $('#error_nis').html('<label class="text-danger">Nis telah digunakan</label>');
                        $('#simpan').attr('disabled', true);
                    }else{
                        $('#error_nis').html('<label class="text-success">Nis dapat digunakan</label>');
                        $('#simpan').attr('disabled', false);
                    }
                },
                error: function (jqXHR, exception) {
